---
title: "Study 5 - Puppy - binomial GLMM - power simulation"
...
con.per <- c(0.58) # performance in pack dog group
test.per <- c(0.3, 0.25) # performance in wolf group
...
summary(full$value)
save.image("power_sim_study6_N80.RData")
```
