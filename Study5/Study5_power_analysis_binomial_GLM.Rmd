---
title: "Study 5 - Wolf - binomial GLMM - power simulation"
...
con.per <- c(0.5) # performance in pack dog group
test.per <- c(0.2, 0.15) # performance in wolf group
...
start.data$sex<-rep(rep(c("m", "f"), each=n.per.condition*n.groups), n.subject)[1:nrow(start.data)]
...
summary(full$value)
save.image("power_sim_study5_N26.RData")
```
