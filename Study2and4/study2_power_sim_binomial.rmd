---
title: "Study 2 - Oxytocin - binomial GLMM - power simulation"
...
con.per <- c(0.58) # performance in placebo dog group
test.per <- c(0.7, 0.75) # performance in oxytocin dog group
...
summary(full$value)
save.image("power_sim_study2_N76.RData")
```
